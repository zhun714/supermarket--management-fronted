<template>
    <div class="stockIn">
        ...
        <div class="header">
            <el-button type="primary" @click="change(0)" round>入库记录</el-button>
            <el-button type="warning" @click="change(1)" round>商品入库</el-button>
        </div>
                        ...
                        <template slot="header" >
                            <div style="display:flex">
                                <el-input
                                    v-model="searchMes"
                                    size="mini"
                                    placeholder="输入商品关键字搜索" style="width:240px;margin-right: 5px"/>
...
/*                console.log(val);*/
            ...
            mesEdit(val){   //编辑信息弹框    //传id给后台，然后再获取数据，再显示
                ...
                this.mesForm.goodsName = this.tableData[val.$index].goodsName;
